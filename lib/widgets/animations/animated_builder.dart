...
class AnimatedBuilderX<T> extends StatefulWidget {
  const AnimatedBuilderX({
    super.key,
  ...
  @override
  AnimatedBuilderXState<T> createState() => AnimatedBuilderXState<T>();
}

class AnimatedBuilderXState<T> extends State<AnimatedBuilderX<T>>
  ...
  void initState() {
    ...
    if (widget is OpacityAnimation) {
      final current =
          context.findRootAncestorStateOfType<AnimatedBuilderXState>();
